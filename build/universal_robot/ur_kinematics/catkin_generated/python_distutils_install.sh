...
echo_and_run cd "/home/vincent/vincent-dev/realsense_acp_robot/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/vincent/vincent-dev/realsense_acp_robot/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/vincent/vincent-dev/realsense_acp_robot/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
