...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetDrivePower-request>)))
  ...
  (cl:format cl:nil "# Direct method of turning drive power on and off~%# NOTE: Motion commands will automatically to this if~%# drive power is not on and a motion command is received.~%~%bool drive_power~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetDrivePower-request)))
  "Returns full string definition for message of type 'SetDrivePower-request"
  (cl:format cl:nil "# Direct method of turning drive power on and off~%# NOTE: Motion commands will automatically to this if~%# drive power is not on and a motion command is received.~%~%bool drive_power~%~%~%"))
